...
Eigen::Matrix2d GxtProjectionTwoFrameOneCamFactor::sqrt_info;
double GxtProjectionTwoFrameOneCamFactor::sum_t;
...
void GxtProjectionTwoFrameOneCamFactor::ComputeResidual() {
...
void GxtProjectionTwoFrameOneCamFactor::ComputeJacobians() {
  Eigen::Vector2d residuals_tmp;
  double *residuals = &residuals_tmp(0);
